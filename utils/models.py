...
class AnalysisRequest(BaseModel):
    ...
    enhance_with_ai: bool = Field(True, description="Whether to enhance with AI insights")

class EnhancementRequest(BaseModel):
    """Request model for AI enhancement."""
    model: str = Field("deepseek-coder:6.7b", description="AI model to use for enhancement")
    include_architecture: bool = Field(True, description="Include architecture analysis")
